...
OUTPUT FORMAT:
Return a valid JSON object where keys are section names and values are the section content in markdown:
{{
    "Executive Summary": "markdown content...",
    "Understanding Your Challenges": "markdown content...",
    ...
}}
...
def writing_agent(state: ProposalState) -> dict:
    ...
    try:
        ...
        proposal_sections: dict[str, str] = json.loads(response_text)
